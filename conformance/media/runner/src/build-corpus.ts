...
function buildLoc04Properties(): void {
  ...
  decode('loc/v4-mixed-01-ids-go-unknown', [{ id: 0x02n, value: 7n }, { id: 0x04n, value: 0x20n }, { id: 0x10n, value: 9n }], 'd16-delta-varint',
    ...
    'A block with both dialects resolves as LOC-04; legacy ids no longer identify LOC fields and remain opaque.', 'v4_mixed.bin');
...
function main(): void {
  ...
  preserveUnmanagedVectors(VECTORS, tmp, new Set(domains.keys()));
